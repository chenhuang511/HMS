        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form method="get" action="" class="form-horizontal tasi-form">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <a href="import" class="btn btn-success m-b-10">Import</a>
                        </div>
                ...
                <table class="table">
                    ...
                    <tr>
                        <th>#</th>
                        <th>{{ labelkey['device.name'] }}</th>
                        <th>{{ labelkey['device.deviceid'] }}</th>
                        <th>{{ labelkey['device.sim'] }}</th>
